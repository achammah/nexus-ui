...
- **Tokens first:** `src/tokens/tokens.css` is the single restyle surface — an app's design lock overrides tokens, never component internals. Light + dark are both first-class (`prefers-color-scheme` + `[data-theme]` override).
