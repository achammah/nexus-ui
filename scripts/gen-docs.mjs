...
/* machine catalog */
writeFileSync(path.join(DOCS, "catalog.json"), JSON.stringify({ generatedAt: new Date().toISOString(), style: manifest.style, count: items.length, items }, null, 2) + "\n");
...
GENERATED by \`node scripts/gen-docs.mjs\` (${new Date().toISOString().slice(0, 10)}) from the live tree — edit the WHEN dictionary in the script, never this file. Machine-readable twin: \`docs/catalog.json\`. Deep docs: \`docs/record-core.md\` (the config-driven record system) · \`AGENTS.md\` (how an agent works in this repo).
