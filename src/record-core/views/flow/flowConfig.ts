...
export const resolveEdgeStyle = (cfg: Record<string, unknown>): EdgeStyle =>
  ALL_EDGE_STYLES.includes(cfg.edgeStyle as EdgeStyle) ? (cfg.edgeStyle as EdgeStyle) : "smoothstep";
...
/* animated edges + transitions when the graph changes */
export const configAnimated = (cfg: Record<string, unknown>): boolean => bool(cfg.animated, true);
