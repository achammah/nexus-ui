...
export interface ViewProps {
  ...
  /* open the host's create flow, optionally seeded (the calendar passes the
     clicked day's date). The host supplies it only when the caller may create —
     absent → the view hides its create affordances. */
